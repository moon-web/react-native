...
class EditModal extends Component{
    ...
    componentWillMount(){
        this.setState({
            ...
            this.props.NickName(this.state.nickName)
        })
    }
    //关闭modal(再想想按钮)
    _closeModal(){
        ...
        return (
            <View style={styles.add_container}>
                <View style={styles.add_title}>
                    <Text style={styles.add_title_text}>编辑公司成员</Text>
                ...
                <View style={styles.add_companyMember}>
                    ...
                    <View style={styles.add_companyMember_item}>
                        ...
                        <MyInput placeholder='请输入成员的姓名'
                                   underlineColorAndroid="transparent"
                                   style={styles.add_companyMember_input}
                                   onChangeText={(text) => {this.props.UserName(text),this.setState({userName:text})}}
                                   value={this.state.userName}
                        />
                    </View>
                    <View style={styles.add_companyMember_item}>
                        <Text>昵称</Text>
                        <MyInput placeholder='请输入成员的昵称'
                                   underlineColorAndroid="transparent"
                                   style={styles.add_companyMember_input}
                                   onChangeText={(text) => {this.props.NickName(text),this.setState({nickName:text})}}
                                   value={this.state.nickName}
                        />
                    </View>
                </View>
                <TouchableOpacity style={styles.add_companyMember_btn} onPress={this._editCompany.bind(this)}>
                    <Text style={styles.add_companyMember_btn_text}>确定</Text>
                </TouchableOpacity>
            </View>
        )
    }
